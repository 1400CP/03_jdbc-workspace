...
public class ProductController {
	...
	// case 2
	public void insertProductIO(String productId, String amount, String status) {
	...
	// case 3
	public void updateProductIO(String productId, String amount, String status) {
	...
	public void searchProductIO(String productName) {
		//select
		ProductIO pd = new ProductService().searchProductIO(productName);
		
		if(pd == null) {
			new ProductMenu().displayFail("실패, 재시도ㄱㄱ");
		}else {
			new ProductMenu().displayProductIO(pd);
		}
