...
public class ProductDao {
	...
	public ArrayList<ProductIO> selectAll(Connection conn) {
		...
		String sql = "SELECT IO_NUM, PRODUCT_ID, P_NAME, IO_DATE, AMOUNT, STATUS FROM PRODUCT_IO JOIN PRODUCT USING (PRODUCT_ID)";
	...
	public ArrayList<ProductIO> selectIn(Connection conn) {
		...
		String sql = "SELECT IO_NUM, PRODUCT_ID, P_NAME, IO_DATE, AMOUNT, STATUS FROM PRODUCT_IO JOIN PRODUCT USING (PRODUCT_ID) WHERE STATUS = '입고'";
	...
	public ArrayList<ProductIO> selectOut(Connection conn) {
		...
		String sql = "SELECT IO_NUM, PRODUCT_ID, P_NAME, IO_DATE, AMOUNT, STATUS FROM PRODUCT_IO JOIN PRODUCT USING (PRODUCT_ID) WHERE STATUS = '출고'";
	...
	public int insertStatus(Connection conn, ProductIO pd) {
		...
		String sql = "INSERT INTO PRODUCT_IO VALUES (SEQ_IO.NEXTVAL, ?, SYSDATE, ?, ?)";
	...
	public int outputStatus(Connection conn, String productId, String amount, String status) {
		...
		String sql = "INSERT INTO PRODUCT_IO (IO_NUM, PRODUCT_ID, IO_DATE, AMOUNT, STATUS) VALUES (SEQ_IO.NEXTVAL, ?, SYSDATE, ?, ?)";
