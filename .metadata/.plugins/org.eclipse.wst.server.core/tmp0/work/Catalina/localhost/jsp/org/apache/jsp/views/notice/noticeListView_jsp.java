 ...
 * Generated at: 2025-02-27 15:33:42 UTC
...
public final class noticeListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/common/menubar.jsp", Long.valueOf(1740462976249L));
  }
  ...
  static {
    ...
    _jspx_imports_classes.add("com.kh.notice.vo.Notice");
 ...
 if(loginUser != null && loginUser.getUserId().equals("admin")) { 
      out.write("\r\n");
      out.write("        <!-- 현재 로그인한 사용자가 관리자일 경우 보여질 div -->\r\n");
      out.write("        <div align=\"right\" style=\"width: 850px\">\r\n");
      out.write("        <!-- <button onclick=\"location.href='요청할url'\">글작성</button>  -->\r\n");
      out.write("            <a href=\"");
      out.print( contextPath );
      out.write("/enrollForm.no\" class=\"btn btn-sm btn-secondary\"> 글작성 </a>\r\n");
      out.write("            <!-- 부트스트랩 활용하기 -->\r\n");
      out.write("            <br><br>\r\n");
      out.write("        </div>\r\n");
      out.write("        ");
 } 
 ...
 if(list.isEmpty()){ 
      ...
      out.write("\r\n");
      out.write("                <!-- case2. 공지글이 있을 경우 -->\r\n");
      out.write("                	");
 for(Notice n: list) { 
      out.write(" <!-- n은 0번 요소부터 -->\r\n");
      out.write("	                <tr>\r\n");
      out.write("	                    <td>");
      ...
      out.write("    			\r\n");
      out.write("    			// 요청할 url? 키=벨류&키=벨류\r\n");
      out.write("    			// 요청시 전달값 (키=벨류) == 쿼리스트링\r\n");
      out.write("    			\r\n");
      out.write("    			// /jsp/detail.no?num=내가누른글번호\r\n");
      out.write("				location.href = '");
      out.print( contextPath);
