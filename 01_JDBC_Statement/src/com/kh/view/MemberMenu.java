...
public class MemberMenu {
	...
	public void inputMember() {
		...
		System.out.println("\n====회원 추가====");
		// NOT NULL을 무조건 확인해야 한다!! 이게 제일 중요하다.
		// 아이디 ~ 취미까지 입력받기
		System.out.print("아이디 : ");
		String userId = sc.nextLine();	// vo와 비슷하게 지어라
		...
		String gender = sc.nextLine().toUpperCase(); // 데이터에서 대문자만 받으니까 추가 메소드를 넣기.
		
		System.out.print("나이 : ");
		String age = sc.nextLine(); // ex) "19"
