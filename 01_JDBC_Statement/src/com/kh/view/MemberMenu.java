...
public class MemberMenu {
	...
	public void inputMember() {
		...
		String gender = sc.nextLine().toUpperCase(); // 모든 글자를 대문자로
	...
	public void updateMember() {
		...
		System.out.println("\n==== 회원 정보 변경 ====");
		// 회원 아이디, 변경할 비번, 변경할 이메일, 변경할 전번, 변경할 주소
		// System.out.println("회원 아이디 입력 : ");	// 메소드 재활용 가능??
		// String userId = sc.nextLine();
		String userId = inputMemberId();			// 메소드 재활용 가능!
