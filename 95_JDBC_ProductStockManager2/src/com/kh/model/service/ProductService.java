...
public class ProductService {
	...
	public int insertStatus(ProductIO pd) {
		Connection conn = driver();
		int result = new ProductDao().insertStatus(conn, pd);
	...
	//case6_5 상품 출고 => insert네
	public int outputStatus(String productId, String amount, String status) {
		Connection conn = driver();
		int result = new ProductDao().outputStatus(conn, productId, amount, status);
