		...
		*/
		String sql = "INSERT INTO COPY_EMP VALUES(SEQ_EMPNO.NEXTVAL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
			...
			try {
				...
				pstmt.setString(5, e.getdCode());
				pstmt.setString(6, e.getjCode());
				pstmt.setString(7, e.getSalLevel());
				pstmt.setInt(8, e.getSalary());
				pstmt.setDouble(9, e.getBonus());
				pstmt.setInt(10, e.getMngId());
				pstmt.setString(11, e.gethDate());
				pstmt.setString(12, e.geteDate());
				pstmt.setString(13, e.geteYn());
