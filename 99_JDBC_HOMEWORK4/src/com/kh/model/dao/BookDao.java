...
public class BookDao {
	...
	//case2_2
	public ArrayList<Book> selectList2(Connection conn) {
		...
		try {
			...
			while(rset.next()) {
				list.add(new Book(rset.getString("BNO"),
								rset.getString("TITLE"),
								rset.getString("AUTHOR"),
								rset.getString("PUBLISHER"),
								rset.getInt("PRICE"),
	...
	//case2_3
	public ArrayList<Magazine> selectList3(Connection conn) {
		//select문, 다행열, ArrayList, ResultSet
		...
		try {
			...
			while(rset.next()) {
				list.add(new Magazine(rset.getString("BNO"),
								rset.getString("TITLE"),
								rset.getString("AUTHOR"),
								rset.getString("PUBLISHER"),
								rset.getInt("PRICE"),
