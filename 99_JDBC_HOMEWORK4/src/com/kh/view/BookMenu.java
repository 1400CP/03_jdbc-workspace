	...
	*/
	public void mainMenu() {
		...
		while (flag == true) { // 메뉴 스위치가 켜져있는 동안 무한반복
			...
			System.out.println("1. 추가하기"); // 성공
			System.out.println("2. 조회하기"); // 아직
			System.out.println("3. 책 찾기"); // 일부 성공
			System.out.println("4. 전체책 가격 합계 및 평균 조회"); // 리턴값을 찾지 못함
	...
	public void selectList() {
		...
		case 1 : bc.selectList1(); // ArrayList
				break;
				
		case 2 : bc.selectList2(); // ArrayList
				break;
				
		case 3 : bc.selectList3(); // ArrayList
				break;
	...
	public void selectBookMenu() {
		...
		case 3 :			// 3. 출간연도로 잡지 찾기, ArrayList
		...
		case 4 : 			// 4. 출판사로 책 찾기 (책 제목 찾기랑 똑같다), ArrayList
			System.out.print("출판사를 입력하세요 : ");
			String publisher = sc.nextLine();
			bc.selectPs(publisher);
			break;
			
		case 5 : 			// 5. 특정 가격 밑으로 책 찾기, ArrayList
			System.out.print("가격을 입력하세요 : ");
			String price = sc.nextLine();
	...
	public void selectBookprice() {
		...
		switch(menu) {
			case 1 :
				bc.getTotalPrice(); //return을 뭘로 해야 하나?
			break;
